          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-xl text-base leading-7 text-[#5c4a2a] sm:text-lg sm:leading-8">
                Hand-picked from family orchards along the Auranga river,
                naturally ripened in hay, and packed the same day they leave the
                tree. No carbide. No middlemen. Just the mango South Gujarat has
                been quietly hoarding for generations.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="paper-shadow relative aspect-[4/5]  rounded-[1.75rem] bg-black">
              <Image
                ...
                alt="Kesar mangoes hanging from a Valsad orchard tree"
                fill
                priority
