...
export default function Home() {
  return (
    <>
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-12 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
          <div className="space-y-8">
            <Badge
              ...
              <span className="size-2 rounded-full bg-[var(--kesar)] mr-2" />
              First Harvest · May 2026 · Now Booking
            </Badge>

            <div className="space-y-5">
              <h1 className="font-heading max-w-4xl text-5xl leading-[0.9]  tracking-[-0.04em] text-[#143018] sm:text-7xl lg:text-[6.75rem]">
                The <em className=" italic text-[var(--kesar-deep)]">Kesar</em>
                <br />
                of Valsad,
              </h1>
          ...
          {trustItems.map((item, index) => {
            ...
            return (
              <div
                ...
                <div className="grid size-10 place-items-center rounded-full border border-[#e9ddb5]/30 text-[var(--mango)]">
        ...
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            title={
              <>
                Three boxes. One{" "}
                <em className="italic text-[var(--kesar-deep)]">
                  extraordinary
                </em>{" "}
                mango.
              </>
      ...
      <section
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 grid gap-8 lg:grid-cols-2 lg:items-end">
            <div>
              <Eyebrow className="text-[var(--mango)]">
                Meet the growers
              </Eyebrow>
              <h2 className="font-heading mt-4 text-4xl leading-15  text-[#fbf5e9] sm:text-7xl">
                ...
                <span className="inline-block text-nowrap">
                  One{" "}
                  <em className="italic text-[var(--mango)] text-nowrap">
                    forty-kilometre
                  </em>{" "}
                </span>
                belt.
            ...
            <p className="max-w-lg ml-auto text-base leading-8 text-[#e9ddb5]/85">
              From Pardi to Dharampur, our partner orchards share one stretch of
              red-black coastal soil, the same earth that has been growing
              Valsadi Kesar for four generations. We do not own a tree. We pay
              above market, in cash, on the day. Every box you open carries the
              lot number of the orchard it came from.
            </p>
          </div>
            ...
            {orchards.map((orchard) => (
              <div
                ...
                <div className="absolute inset-x-4 bottom-4 z-10">
                  ...
                  <div className="mt-1 text-[11px] tracking-[0.18em] uppercase text-[var(--mango)]">
                    {orchard.meta}
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid gap-8 border-t border-[#e9ddb5]/20 pt-8 grid-cols-3 text-center">
            {[
              ...
              <div key={label}>
                <div className="font-heading text-5xl leading-none font-semibold text-[var(--mango)]">
                  {value}
                </div>
          ...
          {/* <div className="mt-10 flex flex-wrap justify-center gap-3">
            <Button
              size="lg"
              className="rounded-full bg-[var(--kesar)] px-5 text-white hover:bg-[var(--kesar-deep)]">
              Watch the harvest
            </Button>
            <Link
              href="#journey"
      ...
      <section id="journey" className="bg-[#f4ead3] px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-5">
            {journeySteps.map((step) => (
              <div key={step.step} className="relative pr-4 ">
                <div className="mb-5 grid size-12 place-items-center rounded-full bg-[#143018] font-heading text-2xl text-[var(--mango)]">
                  {step.step}
                </div>
          ...
          <SectionIntro
            ...
            title={
              <>
                ...
                <em className="italic text-[var(--kesar-deep)]">letter</em>.
              </>
            }
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-12">
            ...
            <SouvenirCard
              ...
              <div className="h-full border border-dashed rounded-t-xl border-[#1f4d2a] bg-[#fffcf4] p-5">
                ...
                <div className="mb-4 text-[10px] tracking-[0.2em] uppercase text-[var(--kesar-deep)]">
                  Every box · Every time
                </div>
                {[
                  ["#5c8a2e", "Day 1–2", "Firm · keep wrapped in newspaper"],
                  ["#bfd66b", "Day 3", "Yields slightly · counter, not fridge"],
            ...
            <SouvenirCard
              ...
              <div className="flex h-full flex-col justify-between bg-[#143018] p-6 text-[#fbf5e9]">
                <div className="flex items-start justify-between">
                  <div className="font-heading text-3xl text-[var(--mango)]">
                    Pakaam
                  </div>
                ...
                <div>
                  <div className="text-[11px] tracking-[0.2em] uppercase text-[var(--mango)]">
                    Family Box · 5 kg
                  </div>
            ...
            <SouvenirCard
              ...
              <div className="relative flex h-full flex-col items-center justify-center border-2 rounded-t-xl border-[#143018] bg-[#f4ead3] p-6 text-center">
                <div className="text-[9px] tracking-[0.3em] uppercase text-[var(--kesar-deep)]">
                  Compliments of
                </div>
              ...
              <div className="grid h-full grid-cols-2 border border-[#1f4d2a]/15 bg-[#fffcf4]">
                ...
                <div className="flex flex-col justify-between p-4">
                  ...
                  <div className="ml-auto w-fit border border-[#143018] px-2 py-1 text-center text-[8px] tracking-[0.15em] uppercase text-[#143018]">
                    Valsad
                    <div className="font-heading text-lg text-[var(--kesar-deep)]">
                      K
                    </div>
                    2026
                  </div>
            ...
            {testimonials.map((item) => (
              <Card
                ...
                <CardContent className="space-y-5 p-7">
                  <div className="flex gap-1 text-[var(--kesar)]">
      ...
      <section id="contact" className="bg-[#f4ead3] px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            eyebrow="Talk to us"
            title={
              <>
                Real humans.
                <br />
                <em className="italic text-[var(--kesar-deep)]">Real</em>{" "}
                orchard.
              </>
            }
            ...
            <Card className="paper-shadow rounded-[1.4rem] border border-[#1f4d2a]/15 bg-[var(--paper)] py-0">
              <CardContent className="p-8 sm:p-10">
                <div className="flex flex-wrap items-start justify-between gap-5">
                  ...
                  <Badge className="rounded-full bg-[#143018] px-4 py-2 text-[11px] tracking-[0.18em] uppercase text-[var(--mango)]">
                    Reply within 1 hour
                  </Badge>
                </div>
            ...
            <div className="grid gap-4">
              <Card className="rounded-[1.4rem] border-none bg-[#143018] py-0 text-[#fbf5e9]">
                <CardContent className="p-8">
                  <div className="text-[11px] tracking-[0.22em] uppercase text-[var(--mango)]">
                    Fastest reply
                  </div>
                  <h3 className="font-heading mt-4 text-4xl text-[#fbf5e9]">
                    WhatsApp us
                  </h3>
                  <p className="font-heading mt-5 text-3xl text-[var(--mango)]">
                    +91 90990 64667
                  </p>
                  ...
                  <Link
                    ...
                    className={cn(
                      buttonVariants({ size: "lg" }),
                      "mt-6 rounded-full bg-[var(--kesar)] px-5 text-white hover:bg-[var(--kesar-deep)]",
                    )}>
...
function FinalCta() {
  return (
    <section className="relative overflow-hidden bg-[var(--kesar)] px-4 py-24 text-[#fffcf4] sm:px-6 lg:px-8 lg:py-28">
      ...
      <div className="relative mx-auto max-w-5xl">
        <div className="paper-shadow rounded-[2rem] border border-white/15 bg-[#b85b0e]/25 px-6 py-10 backdrop-blur-sm sm:px-10 sm:py-12 lg:px-14">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="font-heading mt-6 max-w-4xl text-4xl leading-none text-[#fffcf4] sm:text-6xl lg:text-[4.75rem]">
              Mango season is
              <br />
              <em className="italic text-[#fff4d8]">short.</em>
            </h2>
            ...
            <div className="mt-8 flex w-full flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                ...
                className={cn(
                  buttonVariants({ size: "lg" }),
                  "h-[52px] rounded-full bg-[#fffcf4] px-6 text-[#b85b0e] hover:bg-[#fff4d8]",
                )}>
...
function Navbar() {
  return (
    <div className="sticky top-0 z-40 border-b border-[#1f4d2a]/12 bg-[#fbf5e9]/92 px-4 backdrop-blur-md sm:px-6 lg:px-8">
      <div className="mx-auto flex h-[74px] max-w-7xl items-center justify-between gap-6">
        <Brand />
  ...
  return (
    <div className="mb-12 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
      <div className="max-w-3xl">
        ...
        <h2 className="font-heading mt-4 text-4xl leading-15 text-[#143018] sm:text-7xl">
          {title}
        </h2>
        {copy ? (
    ...
    <div className="flex h-full items-center justify-center bg-gradient-to-b from-[#fbf5e9] to-[#f4ead3] p-5">
      <div className="relative h-[88%] w-[62%]">
        ...
        <div className="absolute inset-x-[10%] bottom-[14%] top-[42%] flex flex-col items-center justify-center border border-[#1f4d2a]/25 bg-[#fbf5e9] px-3 text-center">
          <div className="text-[7px] tracking-[0.28em] uppercase text-[var(--kesar-deep)]">
            Pakaam
          </div>
